      ...
      <Table>
        ...
        <TableBody>
          {items.map((dataset) => {
            ...
            const isPdf = dataset.num_samples === 0 && typeof dataset.generation_metadata?.pdf_uri === "string";
            const showJobCard =
              dataset.source === "sdg" &&
              ...
              <Fragment key={dataset.id}>
                ...
                >
                  ...
                  <TableCell className="text-right font-mono text-xs">
                    {isPdf ? <Badge variant="secondary">PDF</Badge> : dataset.num_samples.toLocaleString()}
                  </TableCell>
